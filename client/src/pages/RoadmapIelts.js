            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="bg-primary-900/50 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white/10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            <h3 className="text-xl font-bold mb-4 text-white/90">Trình độ của tôi (Band hiện tại)</h3>
...
const IELTS_STEP_DATA = [
    {
        ...
        image: { tag: 'Xây dựng nền tảng từ A đến Z', file: '/img/ielts-step-1-foundation.jpg' }
    },
    {
        step: 2,
        ...
        image: { tag: 'Phòng luyện IELTS ảo PREP AI', file: '/img/ielts-step-2-ai-practice.jpg' }
    },
    {
        step: 3,
        ...
        image: { tag: 'Thực chiến & Bứt phá điểm số', file: '/img/ielts-step-3-exam.jpg' }
    },
];
                        ...
                        <AnimatePresence mode="wait"> 
                            ...
                            <div className="text-center w-full h-full">
                                    ...
                                    <div className="w-full h-[85%] mx-auto bg-gray-100 rounded-lg flex items-center justify-center border-4 border-primary-400 overflow-hidden">
                                        [Image of: {currentStep.image.tag}]
...
0, y: 20 }} 
                ...
                >
                    ...
                    <div className="md:w-1/2 p-10 bg-[#f0f5ff] flex flex-col justify-center">
                        ...
                        {/* CHỈNH SỬA MÀU NỀN TẠI ĐÂY (Dùng bg-primary-600 thay cho secondary-600) */}
...
NTTU HUB
                    ...
                    {/* Cột 2: Hình ảnh (Dùng primary-500 
thay cho secondary-500) */}
                    <div className="md:w-1/2 relative bg-primary-500 overflow-hidden flex items-center justify-center">
                        <div className="absolute inset-0 bg-primary-900 opacity-20"></div>
                        [Image of: Banner IELTS Mockup]
...
chọn Trình độ & Mục tiêu */}
            ...
            {/* 4. CTA cuối trang */}
            {/* CHỈNH SỬA MÀU NỀN TẠI ĐÂY (Dùng bg-primary-900 thay cho secondary-900) */}
            <div 
