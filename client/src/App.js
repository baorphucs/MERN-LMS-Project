// FILE_PATH: client/src/App.js (CẬP NHẬT HOÀN TOÀN ĐỂ SỬA LỖI CÚ PHÁP useContext)
import React, { useContext } from 'react'; // <=== ĐÃ THÊM useContext VÀO ĐÂY 
import { BrowserRouter as Router, Routes, Route } from 'react-router-dom';
import { ToastContainer } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css'; 

// Auth Context
import AuthContext, { AuthProvider } from './context/AuthContext'; // Bổ sung AuthContext
